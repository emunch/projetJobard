	...
	<body>
	    ...
	    <table><tr>
	        <td class="menu">
	            ...
	            <div class="menu2"><a class="menu" href="./fr/news.html">News</a></div>
	            <div class="menu2"><a class="menu" href="./fr/download.html">Téléchargements</a></div>
	            <div class="menu2"><a class="menu" href="./fr/changelog.html">Changelog</a></div>
	            <div class="menu2"><a class="menu" href="./fr/issue.html">Problématiques</a></div>
	            <div class="menu2"><a class="menu" href="./fr/bug.html">Bugs</a></div>
	            <div class="menu2"><a class="menu" href="./fr/extension.html">Extensions</a></div>
	            <div class="menu2"><a class="menu" href="./fr/link.html">Liens</a></div>
	            <div class="menu2"><a class="menu" href="./fr/credit.html">Crédits</a></div>
	            <br />
	    ...
	    <div class="title3">Copyright © 2005 <a href="http://www.g-truc.net">G-Truc Creation</a></div>
	    <div class="title3">OpenGL est une marque déposé par Silicon Graphics Inc.</div>
